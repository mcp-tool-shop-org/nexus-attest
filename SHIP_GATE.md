...
- [ ] `[cli|mcp|desktop]` SKIP: library, not a CLI/MCP server/desktop app
...
- [x] `[all]` Errors follow the Structured Error Shape: `code`, `message`, `hint`, `cause?`, `retryable?` (2026-02-27) — typed exceptions
...
- [ ] `[cli|mcp|desktop]` SKIP: library
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[complex]` SKIP: straightforward library
