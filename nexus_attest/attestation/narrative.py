...
Usage:
    from nexus_attest.attestation.narrative import show_intent
...
from nexus_attest.attestation.receipt import RECEIPT_VERSION, AttestationReceipt
...
def _build_canonicalization_block() -> dict[str, str | dict[str, str]]:
    ...
    """
    from nexus_attest.attestation.intent import INTENT_VERSION
    from nexus_attest.attestation.xrpl.memo import MEMO_VERSION
...
def show_intent(
    ...
    *,
    ...
    from nexus_attest.attestation.storage import AttestationStorage
